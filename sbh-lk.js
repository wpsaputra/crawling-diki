  ...
  try {
    ...
    for (let index = 0; index < entrilk_loop.length; index++) {
      ...
      const show_response = await page.evaluate(async (cookies, element, triwulan) => {
        let unlock = await fetch("https://webapps.bps.go.id/olah/sbh2022/resource/entriLK/unlockDokumen", {
          "headers": {
            "accept": "application/json, text/plain, */*",
            "accept-language": "en-US,en;q=0.9",
        ...
        let lock = await fetch("https://webapps.bps.go.id/olah/sbh2022/resource/entriLK/lockDokumen", {
          "headers": {
            "accept": "application/json, text/plain, */*",
            "accept-language": "en-US,en;q=0.9",
            "cache-control": "no-cache",
        ...
        unlock = await fetch("https://webapps.bps.go.id/olah/sbh2022/resource/entriLK/unlockDokumen", {
          "headers": {
            "accept": "application/json, text/plain, */*",
            "accept-language": "en-US,en;q=0.9",
            "cache-control": "no-cache",
      ...
      if(entrilk_loop.length-1==index){
